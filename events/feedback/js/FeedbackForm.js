...
const FeedbackForm = ({data, onSubmit}) => {
  ...
  const myOnSubmit = (event) => {
    ...
    data.salutation = form.querySelector('input[type=radio]:checked').value;
    data.snacks = [];

    let snacks = form.querySelectorAll('input[type=checkbox]:checked');
  ...
  return (
    <form className='content__form contact-form' onSubmit={myOnSubmit} ref={elem => form = elem}>
      ...
      <div className='contact-form__input-group'>
        ...
        <input className='contact-form__input contact-form__input--checkbox' id='snacks-pizza' name='snacks' type='checkbox' value='пицца' defaultChecked={wantToGet['пицца']} />
        <label className='contact-form__label contact-form__label--checkbox' htmlFor='snacks-pizza'>Пиццу</label>
        <input className='contact-form__input contact-form__input--checkbox' id='snacks-cake' name='snacks' type='checkbox' value='пирог' defaultChecked={wantToGet['пирог']} />
